...
-- MAGIC To run this demo, just select the cluster `dbdemos-dlt-loans-d_martins` from the dropdown menu ([open cluster configuration](https://adb-1404982414631766.6.azuredatabricks.net/#setting/clusters/1023-164245-jro3wuht/configuration)). <br />
...
-- MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-engineering%2Fdlt-loans%2F03-Log-Analysis&cid=1404982414631766&uid=276785760796239">
...
-- MAGIC %md
-- MAGIC Your expectations are ready to be queried in SQL! Open the <a href="/sql/dashboards/db155a99-5474-4c22-adba-bea01ad82b73" target="_blank">data Quality Dashboard example</a> for more details.
