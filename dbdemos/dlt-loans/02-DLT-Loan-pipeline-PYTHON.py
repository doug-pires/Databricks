...
# MAGIC
# MAGIC **Your DLT Pipeline is ready!** Your pipeline was started using the SQL notebook and is <a dbdemos-pipeline-id="dlt-loans" href="/#joblist/pipelines/d2d3bae9-d83e-49ad-9aa5-4f98259e9b03">available here</a>.
# MAGIC
# MAGIC <!-- Collect usage data (view). Remove it to disable collection. View README for more details.  -->
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-engineering%2Fdlt-loans%2F02-DLT-Loan-pipeline-PYTHON&cid=1404982414631766&uid=276785760796239">
...
# MAGIC %md ## Next steps
# MAGIC
# MAGIC Your DLT pipeline is ready to be started. <a dbdemos-pipeline-id="dlt-loans" href="/#joblist/pipelines/d2d3bae9-d83e-49ad-9aa5-4f98259e9b03">Click here to access the pipeline</a> created for you using the SQL notebook.
# MAGIC
...
# MAGIC
# MAGIC <a href="/sql/dashboards/db155a99-5474-4c22-adba-bea01ad82b73" target="_blank">Data Quality Dashboard example</a>
